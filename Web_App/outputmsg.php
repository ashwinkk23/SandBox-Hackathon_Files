...
while($mesg=mysqli_fetch_assoc($records))
    {
        if( strcmp($user1,$mesg['Number']) )
        {
            ...
            echo"<br>"; 
            echo"<br>"; 
			if($mesg['link'] != "http://ultimatecorp.esy.es/images/")
				$imgs = $mesg['link'];
			
			/*$imagedata=file_get_contents("http://localhost/um/images/pic1.png");
...
<body>
	<img src= "<?php echo $imgs; ?>" style="width: 450px; height: 300px;"/>
</body>
